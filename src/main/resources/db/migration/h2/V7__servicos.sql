...
create table servico (
    ...
    responsavel_padrao varchar(200),
    forma_preco        varchar(30)    not null default 'VALOR_UNICO',
    valor              numeric(14, 2),
...
create table servico_item (
    ...
    tratamento_preco  varchar(30)    not null default 'INCLUIDO',
    valor             numeric(14, 2),
    unidade_id        uuid references unidade_cobranca (id),
...
create table servico_preco_historico (
    ...
    o_que_mudou     varchar(200)  not null,
    forma_preco     varchar(30),
